...
export function processTextureFile(file, textureType) {
  return new Promise((resolve, reject) => {
    try {
      ...
      // Create a new worker
      const worker = new Worker(new URL('./workers/texture-worker.js', import.meta.url), { type: 'module' });
...
export function processLightingFile(file) {
  return new Promise((resolve, reject) => {
    try {
      ...
      // Create a new worker
      const worker = new Worker(new URL('./workers/lighting-worker.js', import.meta.url), { type: 'module' });
