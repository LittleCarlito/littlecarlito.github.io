...
- refactor(blorkpack): camera controls ([6c6403b](https://github.com/littlecarlito/threejs_site/commit/6c6403b))
...
- refactor(blorktools): animation controller ([3753c8a](https://github.com/littlecarlito/threejs_site/commit/3753c8a))
- refactor(portfolio): cat interaction ([861765a](https://github.com/littlecarlito/threejs_site/commit/861765a))
- refactor(portfolio): flipping diplomas ([7f8aeaf](https://github.com/littlecarlito/threejs_site/commit/7f8aeaf))
- refactor(portfolio): ui interaction handler ([1c3f214](https://github.com/littlecarlito/threejs_site/commit/1c3f214))
- fix(blorkpack): activate mesh ([76946ef](https://github.com/littlecarlito/threejs_site/commit/76946ef))
- fix(blorkpack): activate with rig generation ([ec8f507](https://github.com/littlecarlito/threejs_site/commit/ec8f507))
...
- fix(blorkpack): skipping bad animation tracks ([8c00980](https://github.com/littlecarlito/threejs_site/commit/8c00980))
...
- fix(portfolio): completing background interaction ([795b045](https://github.com/littlecarlito/threejs_site/commit/795b045))
...
- slice(blorkpack): activate mesh enable/disable ([29c4e6a](https://github.com/littlecarlito/threejs_site/commit/29c4e6a))
- slice(blorkpack): activation handler ([1660c07](https://github.com/littlecarlito/threejs_site/commit/1660c07))
...
- slice(blorkpack): collision mesh detection ([a13951d](https://github.com/littlecarlito/threejs_site/commit/a13951d))
- slice(blorkpack): despawn assets ([f2a1696](https://github.com/littlecarlito/threejs_site/commit/f2a1696))
- slice(blorkpack): diploma hover info box ([250ddba](https://github.com/littlecarlito/threejs_site/commit/250ddba))
- slice(blorkpack): glb animation ([810ae5d](https://github.com/littlecarlito/threejs_site/commit/810ae5d))
- slice(blorkpack): kinematic to dynamic ([db0a219](https://github.com/littlecarlito/threejs_site/commit/db0a219))
- slice(blorkpack): memory analyzer ([28eb62f](https://github.com/littlecarlito/threejs_site/commit/28eb62f))
- slice(blorkpack): rig detection ([dba6ac0](https://github.com/littlecarlito/threejs_site/commit/dba6ac0))
- slice(blorkpack): rig interactability ([f958c87](https://github.com/littlecarlito/threejs_site/commit/f958c87))
- slice(blorkpack): rig visualization ([5c32b1e](https://github.com/littlecarlito/threejs_site/commit/5c32b1e))
- slice(portfolio): asset controls ([3ac16e9](https://github.com/littlecarlito/threejs_site/commit/3ac16e9))
...
- slice(portfolio): collision visual ([aacc8f7](https://github.com/littlecarlito/threejs_site/commit/aacc8f7))
